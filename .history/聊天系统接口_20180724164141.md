...
### 请求URL：
> ` http://test.rakumart.com/index.php?mod=inc&act=kefu&str=getMyOrder`
...
> |code |    number   |   - |
> |data |   obj   |   - |
> |friend |   obj   |    好友列表(担当有效)  |
> |mygroup |   obj   |   内部群组列表(担当有效) |
> |group |   array   |    对外群组列表  |
...
> |group[i].chat_log[i].toavatar |   str   |    接收者头像  |
> |group[i].chat_log[i].trltype |   str   |    翻译类型:1为自动翻译开启,2为人工翻译打开 |
